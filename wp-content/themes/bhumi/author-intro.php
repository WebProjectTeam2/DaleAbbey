...
<div class="bhumi_author_detail_section">
	<div class="bhumi_heading_title2">
	<h3><?php esc_html_e('About Author','bhumi'); ?></h3>
	</div>
	<div class="bhumi_author_detail_wrapper">
		<?php echo get_avatar( get_the_author_meta('email') , 90 ); ?>
		<h4 class="bhumi_author_detail_name"><?php the_author(); ?></h4>
