...
Bhumi WordPress Theme, Copyright 2014 bhumi
Bhumi is distributed under the terms of the GNU GPL
...
Bhumi WordPress Theme bundles the following third-party resources:
...
Scroll JS | V 1.0 | bhumi
(c) 2014  | Licensed under the MIT license and GPL license.

bhumi_Theme_Script | V 1.0 | bhumi
(c) 2014  | Licensed under the MIT license and GPL license.

Theme-Footer-Script | V 1.0 | bhumi
(c) 2014  | Licensed under the MIT license and GPL license.
...
= 1.1.6 =
WordPress 4.7 compatible checked.
Custom CSS transferred to default WordPress Custom CSS in WP 4.7.
09/12/2016

= 1.1.5 =
Option to choose slides number added in slider options
Excerpt length and read more button option added in home blog options
